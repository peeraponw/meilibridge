...
use meilibridge::delivery::{ExactlyOnceManager, ExactlyOnceConfig, DeduplicationKey};
...
mod exactly_once_tests {
    ...
    async fn test_deduplication_with_primary_key() {
        ...
        let key1 = create_dedup_key("0/1000", 100, "products")
            .with_primary_key("prod_1".to_string());
        let key2 = create_dedup_key("0/1000", 100, "products")
            .with_primary_key("prod_2".to_string());
