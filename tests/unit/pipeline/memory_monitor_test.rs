...
mod memory_monitor_tests {
        ...
        for i in 0..10 {
            ...
            let handle = tokio::spawn(async move {
                ...
                for j in 0..5 {
                    ...
                    let alloc = monitor_clone.track_event_memory(2 * 1024 * 1024)
    ...
    async fn test_memory_pressure_scenarios() {
        ...
        while tokio::time::Instant::now() < deadline && (!found_queue_pressure || !found_checkpoint_pressure) {
        ...
        assert!(found_queue_pressure, "Should have received queue pressure event");
        assert!(found_checkpoint_pressure, "Should have received checkpoint pressure event");
