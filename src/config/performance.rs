...
fn default_workers_per_table() -> usize {
    4
}
...
fn default_steal_threshold() -> usize {
    50
}
fn default_max_queue_memory_mb() -> usize {
    512
}
fn default_max_checkpoint_memory_mb() -> usize {
    128
}
...
fn default_metric_window_size() -> usize {
    10
}
